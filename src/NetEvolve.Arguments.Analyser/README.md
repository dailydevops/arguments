...
- **10 analyzer rules (NEA0001-NEA0010)** - Covers null checks, string/collection validation, numeric ranges, `Guid`, and disposed-object checks
...
| [NEA0010](https://github.com/dailydevops/arguments/blob/main/docs/analysers/NEA0010.md) | Use ArgumentException.ThrowIfNullOrEmpty for collections | _(NetEvolve.Arguments-only, no CA equivalent)_                                               |
